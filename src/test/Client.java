...
public class Client {
    ...
    private static String url = "rtmp://your.test.server/screen/"; //changed it for posting purposes
    private static String fileName = "/Users/Alya/transcodedvideo.flv";
    ...
    public static void main(String[] args) {
        ...
        InputStream is = Client.class.getResourceAsStream("/libx264-ipod640.ffpreset");
        try {
            props.load(is);
        } catch (IOException e) {
